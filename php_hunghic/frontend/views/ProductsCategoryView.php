      ...
      <div class="row" id="row1">
       ...
       <?php foreach($data as $rows): ?>
        ...
        <div class="form-group col-md-5 col-sm-12 col-lg-3" style="padding-left: 25px; width: 250px; margin: 25px;">
          <div style="width: 250px; height: 350px; padding: 0px; " class="img1"><a href="index.php?controller=products&action=detail&id=<?php echo $rows->id; ?>"><img style="width: 250px; height: 250px; padding: 0px;" src="../assets/upload/products/<?php echo $rows->photo; ?>" title="<?php echo $rows->name; ?>" alt="<?php echo $rows->namee; ?>" class="img-responsive"></a>
            <div class="t">
            ...
            <a style="padding-left: 35%; padding-top: 20px;" href="index.php?controller=cart&action=create&id=<?php echo $rows->idd; ?>" ><input class="bu1" type="button" value="Thêm Vào Giỏ" style="width: 50%; height: 25px; border: none; color: white; border-radius: 10px 10px 10px 10px; "></a>
          </div>
         <?php endforeach; ?>
      </div>
    ...
    <script type="text/javascript">
      <?php $i=0; ?>
            <?php foreach($record as $rows): ?>
              <?php $i++; ?>
      function brandSearch<?php echo $i; ?>(){
        
        var key = document.getElementById('brand-search<?php echo $i; ?>').value;
          $.ajax({
            url: "index.php?controller=search&action=brandSearch&key="+key,
